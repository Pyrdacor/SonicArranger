...
if ($isWindows) {
  ...
  copy "SonicConvert\bin\Any CPU\Release\net6.0\win-x64\publish\SonicConvert.exe" "SonicConvert\SonicConvert.exe"
  7z a SonicConvert-Windows.zip "SonicConvert\SonicConvert.exe"
  copy "SonicConvert\bin\Any CPU\Release\net6.0\win-x86\publish\SonicConvert.exe" "SonicConvert\SonicConvert.exe"
  ...
  7z a SonicConvert-Linux.tar "./SonicConvert/bin/Any CPU/Release/net6.0/linux-x64/publish/SonicConvert"
  ...
  7z a SonicConvert-Linux-Standalone.tar "./SonicConvert/bin/Any CPU/Release/net6.0/linux-x64/publish/SonicConvert"
